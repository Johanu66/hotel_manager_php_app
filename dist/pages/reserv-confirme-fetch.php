...
$colonne = array("date_debut_reservation", "date_fin_reservation", "nom_type_chambre", "nom_chambre", "nom_client", "tarif_montant_chambre_reservee", "occupe_chambre_reservee");
...
$query .= "
SELECT id_reservation, date_debut_reservation, date_fin_reservation, nom_type_chambre, nom_chambre, nom_client, prenom_client, tarif_montant_chambre_reservee, occupe_chambre_reservee, statut_reservation
...
AND statut_reservation = 'Confirmé' 
";
...
if(isset($_POST["search"]["value"]))
{
	...
	$query .= 'OR occupe_chambre_reservee LIKE "%'.$_POST["search"]["value"].'%" )';
}
...
{
	$arrive = '';
	if($row['occupe_chambre_reservee'] == 'Oui')
	{
		$arrive = '<center><span class="badge badge-primary">Oui</span></center>';
	}
	else
	{
		$arrive = '<center><span class="badge badge-danger">Non</span></center>';
	}
	$sub_array = array();
	...
	<div class="btn-group">
      ...
      <div class="dropdown-menu">
        ...
        <a class="dropdown-item view" id="'.$row["id_reservation"].'" href="#">Valider</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item delete" id="'.$row["id_reservation"].'" href="#" data-status="'.$row["statut_reservation"].'">Annuler</a>
      </div>
    </div>
