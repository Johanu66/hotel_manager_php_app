...
if(isset($_POST['btn_action']))
{
    ...
    if($_POST['btn_action'] == 'Enregistrer')
    {
        ...
        }else
        {
            ...
            switch ($_SESSION['type_compte']) {
                case 1:
                    addlog("Enr-01-reserv-confirme", "", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                    break;
                case 2:
                    addlog("Enr-02-reserv-confirme", "", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                    break;
                case 3:
                    addlog("Enr-03-reserv-confirme", "", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                    break;
                case 4:
                    addlog("Enr-04-reserv-confirme", "", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                    break;
            }
    ...
    if($_POST['btn_action'] == 'delete')
    {
        ...
        if ($_SESSION['lang'] == 'EN') {
            $message_statut_change = MESSAGE_STATUT_CHANGE_TYPE_CHAMBRE_EN;
        } else {
            $message_statut_change = MESSAGE_STATUT_CHANGE_TYPE_CHAMBRE_FR;
        }
        ...
        echo json_encode($message_statut_change . $status);
        ...
        switch ($_SESSION['type_compte']) {
            ...
            case 1:
                addlog("Chg-01-reserv-confirme", $nom_chambre. "," .$status, $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
            case 2:
                addlog("Chg-02-reserv-confirme", $nom_chambre. "," .$status, $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
        }
    ...
    if ($_POST['btn_action_view'] == 'consulter') {
        ...
        foreach ($result as $row) {
			...
			<tr>
				...
				<td>' . $_SESSION['prenom_personne'] . ' ' . $_SESSION['nom_personne'] . '</td>
			</tr>
			<tr>
                <td>' . $label_statut . '</td>
				<td>' . $status . '</td>
        ...
        }else
        {
            ...
            echo json_encode('La chambre a été modifiée avec succès.');
               ...
               switch ($_SESSION['type_compte']) {
                ...
                case 1:
                    addlog("Modif-01-reserv-confirme", $_POST['nom_chambre_modif'], $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                    break;
                case 2:
                    addlog("Modif-02-reserv-confirme", $_POST['nom_chambre_modif'], $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                    break;
                case 3:
                    addlog("Modif-03-reserv-confirme", $_POST['nom_chambre_modif'], $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                    break;
            }
