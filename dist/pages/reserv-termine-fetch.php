...
$colonne = array("date_debut_reservation", "date_fin_reservation", "nom_type_chambre", "nom_chambre", "nom_client", "tarif_montant_chambre_reservee", "libere_chambre_reservee");
...
$query .= "
SELECT id_reservation, date_debut_reservation, date_fin_reservation, nom_type_chambre, nom_chambre, nom_client, prenom_client, tarif_montant_chambre_reservee, libere_chambre_reservee, statut_reservation
...
AND statut_reservation = 'Terminé' 
";
...
if(isset($_POST["search"]["value"]))
{
    ...
    $query .= 'OR libere_chambre_reservee LIKE "%'.$_POST["search"]["value"].'%" )';
}
...
{
	$depart = '';
	if($row['libere_chambre_reservee'] == 'Oui')
	{
		$depart = '<center><span class="badge badge-primary">Oui</span></center>';
	}
	else
	{
		$depart = '<center><span class="badge badge-danger">Non</span></center>';
	}
	$sub_array = array();
