...
if(isset($_POST['btn_export_type_chambre'])) {

    if($_POST['export_type_chambre'] == 'pdf') {

        $query = "SELECT * FROM type_chambre ";
        ...
        <div class="table-responsive" style="font-size: 16px !important;">
            ...
            <table border="1" style="border-collapse:collapse;" >
                <tr bgcolor="#c6efce">
                    ...
                    <th>N°</th>
                    <th>'. $nom_type_chambre .'</th>
                    <th>'. $desc_type_chambre .'</th>
                    <th>'. $statut .'</th>
    ...
    if($_POST['export_type_chambre'] == 'word') {
        ...
        if ($_SESSION['lang'] == 'EN') {
            $file_name = 'List of room types_'.$date.'_'.$hour2.'.docx';
        } else {
            $file_name = 'Liste des types de chambre_'.$date.'_'.$hour2.'.docx';
        }
        ...
        switch ($_SESSION['type_compte']) {
            ...
            case 1:
                addlog("Exp-01-type-chambre", "Word", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
            case 2:
                addlog("Exp-02-type-chambre", "Word", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
        }
    ...
    if($_POST['export_type_chambre'] == 'excel') {
        ...
        if ($_SESSION['lang'] == 'EN') {
            ...
            $file_name = 'Liste des types de chambre_'.$date.'_'.$hour2.'.xls';
        }
        ...
        switch ($_SESSION['type_compte']) {
            ...
            case 1:
                addlog("Exp-01-type-chambre", "Excel", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
            case 2:
                addlog("Exp-02-type-chambre", "Excel", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
        }
