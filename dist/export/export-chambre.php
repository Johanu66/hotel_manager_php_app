...
if(isset($_POST['btn_export_chambre'])) {

    if($_POST['export_chambre'] == 'pdf') {
        ...
        if ($_SESSION['lang'] == 'EN') { 
            $nom_chambre = NOM_CHAMBRE_EN;
            $type_chambre = TYPE_CHAMBRE_EN;
            $desc_chambre =  DESC_CHAMBRE_EN;
            $statut =  STATUT_EN;
            $statut_actif = STATUT_ACTIF_EN;
            $statut_inactif = STATUT_INACTIF_EN;
            $titre = 'List of rooms on '.$date.' at '.$hour.' (GMT)';
        } else {
            $nom_chambre = NOM_CHAMBRE_FR;
            $type_chambre = TYPE_CHAMBRE_FR;
            $desc_chambre =  DESC_CHAMBRE_FR;
            $statut =  STATUT_FR;
            $statut_actif = STATUT_ACTIF_FR;
            $statut_inactif = STATUT_INACTIF_FR;
            $titre = 'Liste des chambres en date du '.$date.' à '.$hour.' (Heure GMT)';
        }
        ...
        if ($_SESSION['lang'] == 'EN') {
            ...
            $file_name = 'Liste des chambres_'.$date.'_'.$hour2.'.pdf';
        }
        ...
        switch ($_SESSION['type_compte']) {
            ...
            case 1:
                addlog("Exp-01-chambre", "PDF", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
            case 2:
                addlog("Exp-02-chambre", "PDF", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
        }
    }


    if($_POST['export_chambre'] == 'word') {
        ...
        if ($_SESSION['lang'] == 'EN') {
            ...
            $file_name = 'Liste des chambres_'.$date.'_'.$hour2.'.docx';
        }
        ...
        switch ($_SESSION['type_compte']) {
            ...
            case 1:
                addlog("Exp-01-chambre", "Word", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
            case 2:
                addlog("Exp-02-chambre", "Word", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
        }
    ...
    if($_POST['export_chambre'] == 'excel') {
        ...
        if ($_SESSION['lang'] == 'EN') {
            ...
            $file_name = 'Liste des chambres_'.$date.'_'.$hour2.'.xls';
        }
        ...
        switch ($_SESSION['type_compte']) {
            ...
            case 1:
                addlog("Exp-01-chambre", "Excel", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
            case 2:
                addlog("Exp-02-chambre", "Excel", $_SESSION["prenom_personne"]." ".$_SESSION["nom_personne"]);
                break;
        }
